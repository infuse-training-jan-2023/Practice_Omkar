from arrays import ArrayTasks

class Test_Arrays:
	def test_instance_of_ArrayTasks(self):
		obj = ArrayTasks([9, 5, 1, 2, 3, 4, 0, -1])
		assert(isinstance(obj, ArrayTasks))
